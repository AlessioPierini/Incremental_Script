...
:BACKUP
color 0f
net use R: \\10.2.1.10\backupsistemidiproduzione
...
Set Opt1=/E /R:3 /W:3 /V /Z /tee /LOG:C:\LOG\LOG_%mydate%.txt		
...
REM Si possono usare credenziali diverse usando "  net use x: \\myserver\fileshare /user:MyID MyPassword  "
